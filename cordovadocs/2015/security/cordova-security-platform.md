...
See the **[Cordova whitelist and Content Security Policy guide](cordova-security-whitelists.md)** for additional details on configuring a CSP policy to meet your needs.
...
Note that there are some nuances on how these whitelist work and both Windows Phone 8.0 and Windows / Windows Phone 8.1 do not support all of these elements. See the **[Cordova whitelist and Content Security Policy guide](cordova-security-whitelists.md)** for additional details.
