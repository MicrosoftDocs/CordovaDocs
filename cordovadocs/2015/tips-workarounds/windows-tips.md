...
* Unhandled exception running on Windows?
    ...
    If you see same exception when targeting Win/WinPhone 8.1, follow the [steps here](/visualstudio/cross-platform/tools-for-cordova/first-steps/getting-started-with-ionic?view=toolsforcordova-2015&preserve-view=true) to call platformOverrides.js to fix this issue.
